 ...
 */
export var getDomainOfDataByKey = function getDomainOfDataByKey(data, key, type) {
  if (type === 'number') {
 ...
 * @return {Array}        Domain
 */
export var getDomainOfItemsWithSameAxis = function getDomainOfItemsWithSameAxis(data, items, type) {
...
export var getTicksOfScale = function getTicksOfScale(scale, opts) {
  ...
  if (tickCount && type === 'number' && originalDomain && (originalDomain[0] === 'auto' || originalDomain[1] === 'auto')) {
    ...
    var _tickValues = getTickValues(_domain, tickCount, allowDecimals);
