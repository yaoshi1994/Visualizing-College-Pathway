...
var CartesianGrid = pureRender(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(CartesianGrid, [{
    ...
    value: function renderHorizontal(horizontalPoints) {
      ...
      var props = getPresentationAttributes(this.props);
      var items = horizontalPoints.map(function (entry, i) {
        return React.createElement('line', _extends({}, props, { fill: 'none', key: 'line-' + i, x1: x, y1: entry, x2: x + width, y2: entry }));
      });
    ...
    value: function renderVertical(verticalPoints) {
      ...
      var items = verticalPoints.map(function (entry, i) {
        return React.createElement('line', _extends({}, props, { fill: 'none', key: 'line-' + i, x1: entry, y1: y, x2: entry, y2: y + height }));
      });
